...
public class LoggedNetworkPIDFeedforwardGains {
    ...
    public LoggedNetworkPIDFeedforwardGains(double defaultKP, double defaultKI, double defaultKD,
                                     double defaultKA, double defaultKV,
                                     double defaultKS, double defaultKG,
                                     String namePrefix) {
