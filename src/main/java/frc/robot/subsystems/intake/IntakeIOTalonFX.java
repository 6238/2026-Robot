...
public class IntakeIOTalonFX implements IntakeIO {
	...
	private Alert intakeArmConfigAlert = new Alert("CRITICAL", "Failed to Configure Intake Arm Motor",
			AlertType.kError);
	private Alert intakeConfigAlert = new Alert("CRITICAL", "Failed To Configure Intake Motor", AlertType.kError);
